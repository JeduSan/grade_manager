...
<div class="col-auto p-0" id="sidebar">
    <div class="d-flex flex-column align-items-center align-items-sm-start text-white min-vh-100">
        ...
        <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
            <li>
                <a href="/admin/dashboard" class="nav-link px-0 align-middle text-white">
                    <i class="fas fa-tachometer-alt icon-size"></i> <span class="ms-1">Dashboard</span>
                </a>
            </li>
            <li>
                <a href="/admin/manager/teacher" class="nav-link px-0 align-middle text-white">
                    <i class="fas fa-user icon-size"></i> <span class="ms-1">Manage Teachers</span>
                </a>
            </li>
            <li>
                <a href="/admin/manager/student" class="nav-link px-0 align-middle text-white">
                    <i class="fas fa-users icon-size"></i> <span class="ms-1">Manage Students</span>
                </a>
            </li>
            <li>
                <a href="/admin/manager/class" class="nav-link px-0 align-middle text-white">
                    <i class="fas fa-chalkboard-teacher icon-size"></i> <span class="ms-1">Manage Class</span>
                </a>
            </li>
            <li>
              <a href="/admin/manager/subject" class="nav-link px-0 align-middle text-white">
